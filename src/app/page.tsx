...
export default function Home() {
  return (
    <div className="font-sans min-h-screen flex flex-col">
      {/* Navbar */}
      <header className="w-full bg-[#131520] text-white">
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center">
              <Image
                ...
                className="h-7 w-7"
              />
              <span className="ml-2 text-lg font-medium text-white">Somnia SDK Docs</span>
            </div>
            
            {/* Documentation navigation */}
            <div className="flex items-right space-x-6">
              <a href="#" className="text-white hover:text-blue-400">Documentation</a>
            </div>
